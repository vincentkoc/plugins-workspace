 ...
 * - **Linux / FreeBSD:** Can only unregister the scheme if it was initially registered with {@link register}. Requires `update-desktop-database`. May not work on older distros.
 * - **macOS / Android / iOS:** Unsupported.
 *
