 ...
 * - **Linux:** Can only unregister the scheme if it was initially registered with {@link register}. Refreshes the desktop database with `update-desktop-database`; if the command cannot run, a warning is logged and {@link isRegistered} may keep returning `true`. May not work on older distros.
 * - **macOS / Android / iOS:** Unsupported.
 *
