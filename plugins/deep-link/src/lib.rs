...
mod imp {
    ...
    impl<R: Runtime> DeepLink<R> {
        ...
        /// ## Platform-specific:
        ///
        /// - **Linux / FreeBSD**: Can only unregister the scheme if it was initially registered with [`register`](`Self::register`). Requires `update-desktop-database`. May not work on older distros.
        /// - **macOS / Android / iOS**: Unsupported, will return [`Error::UnsupportedPlatform`](`crate::Error::UnsupportedPlatform`).
