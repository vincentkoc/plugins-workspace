...
impl Update {
    ...
    ///
    /// On BSD, installation returns [`Error::UnsupportedOs`].
...
// BSD applications can check and download updates with a custom target, but
// their packages cannot be installed by the Linux AppImage/deb/rpm handlers.
#[cfg(any(
    target_os = "dragonfly",
    target_os = "freebsd",
    target_os = "netbsd",
